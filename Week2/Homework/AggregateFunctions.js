...
connection.query(`SELECT gender, COUNT(DISTINCT paper_title) AS female_research_papers
FROM authors
LEFT JOIN authors_papers
ON authors.author_no = authors_papers.author_no
...
connection.query(`SELECT university , COUNT(DISTINCT authors_papers.paper_id)
FROM authors
LEFT JOIN authors_papers
ON authors.author_no = authors_papers.author_no
GROUP BY university
ORDER BY COUNT(DISTINCT authors_papers.paper_id) DESC`
,resErr);
