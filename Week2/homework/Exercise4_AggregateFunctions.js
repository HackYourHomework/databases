...
const SUM_FEMALE_PAPERS = `SELECT COUNT(research_papers.paper_id) AS Female_Count, authors.gender
...
const SUM_PAPERS_AUTHORS_PER_UNIVERSITY = `SELECT COUNT(research_papers.paper_id) AS Sum_Papers, authors.author_name, authors.university
                                            FROM authors INNER JOIN
                                                  authors_research_papers ON authors.author_no = authors_research_papers.author_no INNER JOIN
                                                  research_papers ON authors_research_papers.paper_id = research_papers.paper_id
                                            GROUP BY authors.university`;
