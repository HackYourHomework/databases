...
const insertQueries = [
  {
    ...
    values: [
      ...
      [1, "Smol JP", "Oxford", "1959-10-8", 250, "m", 7],
      [2, "Xie P", "Stanford ", "1953-9-8", 90, "f", 7],
      [3, "Effler SW", "California ", "1956-10-8", 21, "m", 4],
      [4, "Hecky RE", "Zurich", "1953-9-10", 52, "f", 11],
      [5, "Lotter AF", "Cambridge", "1956-9-8", 75, "m", 10],
      ...
      [12, "Cirpka OA", "Harvard", "1950-4-10", 10, "f", 2],
      [13, "Rinaldo A", "Yale", "1959-12-4", 140, "m", 6],
      [14, "Middelburg JJ", "Harvard", "1953-2-8", 47, "f", 7],
    ],
    message: "",
  },
  {
