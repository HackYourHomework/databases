...
async function seedDatabase() {
  ...
  const SELECT_ALL_PAPERS_FEMALE = `SELECT count(DISTINCT research_papers.paper_title)  from research_papers JOIN author_research  ON research_papers.paper_id=author_research.paper_id  JOIN authors ON authors.author_no=author_research.author_number GROUP BY authors.gender HAVING authors.gender="F"`;
