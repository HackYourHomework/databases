...
con.query(inviteeInsertQuery, [inviteeData], (err, result) => {
  if (err) throw err;
...
const meetingData = [
  [1, "This is meeting about subject 1", addDays(dateNow,1), addDays(dateNow,2), 1],
  [2, "This is meeting about subject 2", addDays(dateNow,3), addDays(dateNow,4), 2],
  [3, "This is meeting about subject 3", addDays(dateNow,5), addDays(dateNow,6), 3],
  [4, "This is meeting about subject 4", addDays(dateNow,7), addDays(dateNow,8), 4],
  [5, "This is meeting about subject 5", addDays(dateNow,9), addDays(dateNow,10), 5],
];
