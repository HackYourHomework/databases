...
const create_Meeting  = "create table Meeting (meeting_no int PRIMARY KEY, meeting_title varchar(50),  starting_time DATETIME , ending_time DATETIME)";

function create_tables(create_query){
...
create_tables(create_Invitee);
create_tables(create_Room);
create_tables(create_Meeting);

const array_invitee = [
  "INSERT INTO Invitee VALUES (1, 'Dan', 'fade')",
  "INSERT INTO Invitee VALUES (2, 'sarah', 'nizami')",
  "INSERT INTO Invitee VALUES (3, 'marwa', 'khalid')",
  "INSERT INTO Invitee VALUES (4, 'atabek', 'ahmed')",
  "INSERT INTO Invitee VALUES (5,'ehab','ali')"
];

 const array_room = ["INSERT INTO Room VALUES (1, 'Dan', 10)",
 "INSERT INTO Room VALUES (2, 'manal', 20)",
 "INSERT INTO Room VALUES (3, 'yasmin', 30)",
 "INSERT INTO Room VALUES (4, 'ellen', 40)",
